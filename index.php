<?php
session_start();
$koneksi = new mysqli("localhost", "root", "", "db_varietastanaman"); ?>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="vendor/scss/bootstrap.css">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="index.php?halaman=registeruser">
                        <i class="fa fa-list" aria-hidden="true"></i>
                        <span>Registrasi User</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link collapsed" href="index.php?halaman=lihatdata">
                        <i class="fa fa-eye" aria-hidden="true"></i>
                        <span>Lihat Data Peneliti</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link collapsed" href="index.php?halaman=cetakdata">
                        <i class="fa fa-print" aria-hidden="true"></i>
                        <span>Cetak Data Peneliti</span>
                    </a>
                </li>
                    ...
                    <div class="page-wrapper">
                        <div class="page-inner">
                            ...
                            if (isset($_GET["halaman"])) {
                                if ($_GET["halaman"] == "lihatdata") {
                                    include "tampil_data.php";
                                }elseif ($_GET["halaman"] == "detaildata") {
                                    include "detail_data.php";
                                }elseif ($_GET["halaman"] == "logout") {
                                    include "logout.php";
                                }elseif ($_GET["halaman"] == "registeruser"){
                                ...
                                }elseif($_GET["halaman"] == "cetakdata"){
                                    include "cetak_data.php";
                                }
                            }else {
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Balitri 2020</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
